...
import { appLoggerMaker, httpLoggerMiddlewareMaker, metricsMiddlewareMaker, requestBodyToJsonMiddleware } from "./server.express.config";


// TODO We should test that in e2e fashion
export const createServerFromApplicationConfiguration = async (
  ...
  application.get("/", ((_req: express.Request, res: express.Response): express.Response => res.send("Hello World !")));
